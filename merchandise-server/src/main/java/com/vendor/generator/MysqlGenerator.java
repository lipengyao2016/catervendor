...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        projectPath = ClassUtils.getDefaultClassLoader().getResource("").getPath();
        ...
        dsc.setUrl("jdbc:postgresql://localhost:5432/VD_MerchandiseServerDB");
        ...
        pc.setModuleName("vendor");
        pc.setParent("com");
        // 这个地址是生成的配置文件的包路径
        pc.setEntity("bean.merchandise2");
