...
public class ClassUtil {
	public static Map<String, Class> getAllDtoClass(String packageName) throws ClassNotFoundException {
		List<Class> classes = ClassUtil.getAllClassByInterface(Class.forName(packageName));
