...
public class UserRoleViewServiceImpl implements IUserRoleViewService {
   ...
   // @Autowired
    ...
    @Override
    public UserRoleViews get(Long id) {
        return null;
    }
    ...
    @Override
    public UserRoleViews update(Long id, UserRoleViews updateObj) throws DataNotFoundException {
        return null;
    }

    @Override
    public UserRoleViews delete(Long id) {
        return null;
    }
    ...
    @Override
    public UserRoleViews batchUpdate(List<Long> ids, UserRoleViews updateObj) throws DataNotFoundException {
        return null;
    }
